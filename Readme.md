...
-	"-m2" ou "--m2": Un nombre décimal correspondant à la différence moyenne entre la moyenne totale et la moyenne des gènes différentiellement exprimé avec des valeurs peu élevées. Sa valeur par défaut est : --m1=0.8
...
-	"-t" ou "--tables" : Un vecteur de caractére contenant les noms des matrices des données à fusionner. Par défaut : "--tables"= " MicroArray_simulation.txt, RNA-seq_simulation.txt"
