...
counts.simulation <- function(nGenes, n1, n2, pi0, up, fc){ 
	...
	replace=TRUE			
	  ...
	  TP_up <- round(TP * up)
	  TP_down <- TP - TP_up 
	  ## TP avec des LFC ̩lev̩s en valeur absolue
	  TP_up_up=round((TP_up/2))
	  TP_down_down=round((TP_down/2))
	  #//.......................................................................................................//##
	  ## vecteur des DE: 1 pour les g̬nes Up, -1 pour les g̬nes down et 0 pour les g̬nes non DE
	  DE <- c( rep(1, TP_up), rep(-1, TP_down),rep(0, FP))
	   #//.......................................................................................................//##
	    ## LFC, environ moiti̩ positif, moiti̩ n̩gatif (pour les g̬nes diff̩rentiellement exprim̩s (DE))
	  delta <- rep(0, nGenes)
